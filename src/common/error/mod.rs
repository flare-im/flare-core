...
pub use flare_error::{FlareError, ClientError, ServerError, Result};
...
mod tests {
    ...
    fn test_error_category() {
        assert_eq!(ErrorCode::ConnectionFailed.category(), ErrorCategory::Connection);
        assert_eq!(ErrorCode::AuthenticationFailed.category(), ErrorCategory::Authentication);
        assert_eq!(ErrorCode::SerializationError.category(), ErrorCategory::Serialization);
    }
